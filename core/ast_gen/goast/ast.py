...
class FuncType(IndexUtil):
    def __init__(self, params: FieldList, results: FieldList, lineno: int, index: int):
        super(FuncType,self).__init__(lineno,index)
        self.params = params
...
class SelectorExpr(IndexUtil):
    def __init__(self, x: str, sel: str, lineno: int, index: int):
        super(SelectorExpr, self).__init__(lineno, index)
        self.x = x
        self.sel = sel

class CallExpr(IndexUtil):
    def __init__(self, fun: str, args: list, lineno: int, index: int, ellipsis=False):
        super(CallExpr, self).__init__(lineno, index)
        self.fun = fun
        self.args = args
